		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12">
					<nav id="header_wrap" class="navbar text-uppercase">
						<div class="navbar-header main-menu" style="width: 40%;">
							<ul class="nav navbar-nav">
								<li class="dropdown"><a class="" href="#Pots">Pots</a></li>
								<li class="dropdown"><a class="" href="#Plants">Plants</a>
								</li>
								<li class="dropdown"><a class="" href="#Flowers">Flowers</a>
								</li>
							</ul>
						</div>
						...
						<div class="inline-col-group  main-menu" style="width: 40%;">
							<div class="inline-col-group-right widget">
								<div class="inline-blocked">
									<a href="#"> <span class="inline-blocked padding">Search</span>
								...
								<div class="inline-blocked">
									<div class="inline-col-group-right widget " style="">
										<a href="#"> <span class="inline-blocked padding">Login</span>
										</a>
									</div>
								</div>
								<div class="inline-blocked">
